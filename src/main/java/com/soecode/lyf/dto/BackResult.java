...
public class BackResult implements Serializable{
    ...
    public BackResult(Integer status, String msg, Object data) {
        this.status = status;
        this.msg = msg;
        this.data = data;
    }

    public BackResult(Object data) {
        this.status = 200;
        this.msg = "OK";
        this.data = data;
    }
...
//    }
    ...
    public static JSONObject string2Json(String key,String value) {
    	
    	String temp_json = "{"+key+":" + value + "}";
    	
    	return  JSONObject.fromObject(temp_json);
    }
}
